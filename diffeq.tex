\setchaptergraphic{
    \begin{tikzpicture}[
        ...
        \begin{scope}[decoration={
            ...
            \foreach \h in {0.7,0.9}{
	            \addplot[blue, domain=0:3, postaction={decorate}, samples=60, variable=\t] plot ({\h*f(t)+(1.0-\h)*0.5*s(t)},{\h*g(t)+(1.0-\h)*0.5*d(t)});
        ...
        \begin{scope}[decoration={
            ...
            mark=at position 0.6 with {\arrow{latex reversed}}}
            ]

            \addplot[very thick, domain=-1:1, postaction={decorate}] plot {2*x};
        \end{scope}

        \begin{scope}[decoration={
            markings,
            mark=at position 0.4 with {\arrow{latex reversed}},
