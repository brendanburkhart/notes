...
\begin{prop}
    Consider a local parameterization $m: \R^2 \to S$, and $w \in T_pS$, $\alpha: (-\varepsilon, \varepsilon) \to S$ such that $\alpha(t) = (u(t), v(t))$ and $w = \alpha'(0)$. Then there exist $E, F, G \in \R$ such that
    \begin{align*}
...
\begin{proof}
    ...
    \begin{align*}
        I_p(w) &= \left\langle \frac{\partial m}{\partial u}u'(0) + \frac{\partial m}{\partial v}v'(0), \frac{\partial m}{\partial u}(p)u'(0) + \frac{\partial m}{\partial v}(p)v'(0) \right\rangle \\
