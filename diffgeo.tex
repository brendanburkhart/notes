...
\begin{figure}[h!]
    ...
    \begin{minipage}[b]{0.3\linewidth}
        \begin{tikzpicture}
            ...
            \draw (0,0) circle (2cm);
            \shade[ball color=blue!60!white,opacity=0.5] (0,0) circle (2cm);
        \end{tikzpicture}
    \end{minipage}
    \begin{minipage}[b]{0.3\linewidth}
        \begin{tikzpicture}
            ...
            \begin{scope}
                ...
                \shade[left color=blue!70!white,right color=blue!100!white,middle color=blue!5!white,shading angle=105,opacity=0.5] (-1.5, -1) rectangle (2.5, 3);
            \end{scope}
    ...
    \begin{minipage}[b]{0.3\linewidth}
        \begin{tikzpicture}[
            ...
            \begin{scope}
                ...
                \shade[top color=blue!60!white,bottom color=blue!60!white,middle color=blue!10!white,shading angle=18,opacity=0.6] (0,-2) rectangle (4,1);
            \end{scope}
            \begin{scope}
                \path[clip] plot[domain=-1:-2] ({u(\x)}, {v(\x)}) -- plot[domain=-2:-1] ({u(\x)+3}, {v(\x)+1}) -- cycle;
                \shade[left color=blue!5!white,right color=blue!60!white,opacity=0.6] (-2,-2) rectangle (3,3);
            \end{scope}
            \begin{scope}
                \path[clip] plot[domain=1:2] ({u(\x)}, {v(\x)}) -- plot[domain=2:1] ({u(\x)+3}, {v(\x)+1}) -- cycle;
