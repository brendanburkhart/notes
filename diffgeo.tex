...
\begin{figure}[h!]
    ...
    \begin{minipage}[b]{0.3\linewidth}
        \begin{tikzpicture}
            ...
            \draw (0,0) circle (2cm);
            \shade[ball color=blue!60!white,opacity=0.20] (0,0) circle (2cm);
        \end{tikzpicture}
    \end{minipage}
    \begin{minipage}[b]{0.3\linewidth}
        \begin{tikzpicture}
            \draw (-1.5,0) arc (180:360:1.5cm and 0.45cm) -- (0,3) -- cycle;
            \draw[dashed] (-1.5,0) arc (180:0:1.5cm and 0.45cm);
            \shade[left color=blue!5!white,right color=blue!60!white,opacity=0.3] (-1.5,0) arc (180:360:1.5cm and 0.45cm) -- (0,3) -- cycle;
        \end{tikzpicture}
    \end{minipage}
