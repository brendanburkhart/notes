...
\begin{proof}
    Assume the second case is true, so there exists $y \in \R^m$ such that $A^{\transpose}y < \vec{0}$. Equivalently, there exists $\varepsilon > 0$ such that $A^{\transpose}y + \varepsilon\vec{1} \leq \vec{0}$. However, this is equivalent to saying that there exists
    \begin{align*}
        \begin{bmatrix}
            y \\ \varepsilon
    ...
    \end{align*}
    Then by Farkas \ref{farkas}, we know that there cannot be any $x \geq \vec{0}$ such that
    \begin{align*}
        \begin{bmatrix}
            A \\ \vec{1}^{\transpose}
    ...
    \end{align*}
    Therefore, the first case must be false, or else we could take
    \begin{align*}
